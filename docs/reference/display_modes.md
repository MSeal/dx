Adjust the display mode as necessary with `set_display_mode()` using either `plain`, `simple`, or `enhanced` [display modes](https://noteable-io.github.io/dx/reference/display_modes/).
